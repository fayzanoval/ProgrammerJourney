...
mysqli_free_result($result); 
    ...
    if (empty($nim)) { $pesan_error .= "NIM belum diisi <br>"; } 
...
if (empty($jurusan)) { $pesan_error .= "Jurusan belum diisi <br>"; } 
...
switch($fakultas) 
{ case "Kedokteran" : 
    $select_kedokteran = "selected"; break; 
case "FMIPA" : 
    $select_fmipa = "selected"; break; 
case "Ekonomi" : 
    $select_ekonomi = "selected"; break; 
case "Teknik" : 
    $select_teknik = "selected"; break; 
case "Sastra" : 
    $select_sastra = "selected"; break; 
case "FASILKOM" : 
    $select_mysql = "selected"; break; } 
...
$query .= "tanggal_lahir = '$tgl_lhr', 
            fakultas='$fakultas', "; 
$query .= "jurusan = '$jurusan', 
            ipk=$ipk "; 
$query .= "WHERE nim = '$nim'"; $result = mysqli_query($link, $query); 
//periksa hasil query 
if($result) {
    ...
    <div class="container">
        ...
        if ($pesan_error !== "") { echo "<div class=\"error\">$pesan_error</div>"; } 
            ...
            <fieldset>
                ...
                <p> <label for="nim">NIM : </label> <input type="text" name="nim" id="nim" value="<?php echo $nim ?>" readonly> (tidak bisa diubah di menu edit) </p>
                ...
                <p> <label for="fakultas">Fakultas : </label> <select name="fakultas" id="fakultas">
                        ...
                        <option value="Ekonomi" <?php echo $select_ekonomi ?>> Ekonomi</option>
                        <option value="Teknik" <?php echo $select_teknik ?>> Teknik</option>
                        <option value="Sastra" <?php echo $select_sastra ?>> Sastra</option>
                        <option value="FASILKOM" <?php echo $select_fasilkom ?>> FASILKOM</option>
                    </select> </p>
                <p> <label for="jurusan">Jurusan : </label> <input type="text" name="jurusan" id="jurusan" value="<?php echo $jurusan ?>"> </p>
                <p> <label for="ipk">IPK : </label> <input type="text" name="ipk" id="ipk" value="<?php echo $ipk ?>"> (angka desimal dipisah dengan karakter titik ".") </p>
            </fieldset> <br>
            <p> <input type="submit" name="submit" value="Update Data"> </p>
        </form>
    </div>
</body>
