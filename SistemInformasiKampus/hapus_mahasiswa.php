            ...
            <tr>
                ...
                <th></th>
                    ...
                    while ($data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>$data[ipk]</td>";
                        echo "<td>"; ?> <form action="hapus_mahasiswa.php" method="post"> <input type="hidden" name="nim" value="<?php echo "$data[nim]"; ?>"> <input type="submit" name="submit" value="Hapus"> </form> <?php echo "</td>";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                echo "</tr>";
                                                                                                                                                                                                                                                                                                                                                                                                                                                            } // bebaskan memory mysqli_free_result($result); // tutup koneksi dengan database mysql mysqli_close($link); 
                                                                                                                                                                                                                                                                                                                                                                                                                                                                ?>
        </table>
        <div id="footer">
            Copyright © <?php echo date("Y"); ?> FTIK USM </div>
    </div>
</body>
